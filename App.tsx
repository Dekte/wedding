...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (to) {
      ...
      // Fallback: check hash if search param fails (e.g. #GuestName)
        ...
        <RetroWindow title="SYSTEM_ALERT" className="z-10 max-w-md w-full animate-float">
          <div className="flex flex-col items-center gap-6 py-6">
            <div className="w-32 h-32 relative border-4 border-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] bg-white overflow-hidden">
               <img src={CONFIG.couple.bride.photo} alt="Couple" className="object-cover w-full h-full" />
            ...
            <div className="space-y-2">
              ...
              <p className="font-console text-lg text-black">
                To: <span className="bg-black text-neon-green px-1 text-white font-bold">{guestName}</span>
              </p>
            </div>

            <p className="text-sm font-console text-gray-600">
              Initializing joyful event protocols...<br/>
              Are you ready to join the simulation?
            </p>

            <PixelButton onClick={handleEnter} className="w-full">
              OPEN INVITATION [ENTER]
            </PixelButton>
          </div>
        </RetroWindow>

        <audio ref={audioRef} src={CONFIG.audio.bgmUrl} loop />
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#111] text-gray-200 overflow-x-hidden selection:bg-pink-500 selection:text-white pb-20">
      ...
      <div className="fixed top-4 right-4 z-50">
        <button 
          onClick={toggleMusic}
          className={`w-12 h-12 flex items-center justify-center border-2 border-white rounded-full ${isPlaying ? 'bg-green-500 animate-spin-slow' : 'bg-red-500'}`}
        >
      ...
      <header className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden">
        {/* Parallax Background */}
        <div 
          className="fixed inset-0 w-full h-full z-0 pointer-events-none will-change-transform"
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 max-w-4xl w-full">
          ...
          <div className="w-full bg-neon-green bg-pink-600 text-white overflow-hidden border-y-2 border-white shadow-lg">
            <div className="whitespace-nowrap animate-[marquee_10s_linear_infinite] font-pixel text-xl py-1">
              {CONFIG.hero.marqueeText}
            </div>
          </div>
          ...
          <div className="bg-black/80 backdrop-blur-sm p-8 border-4 border-white shadow-[8px_8px_0_0_#ff00ff] text-center transform -rotate-1 hover:rotate-0 transition-transform duration-500">
            ...
            <p className="font-console text-xl mt-4 max-w-lg mx-auto leading-relaxed">
              {CONFIG.hero.subtitle}
            </p>
          </div>

          <div className="animate-bounce mt-10 drop-shadow-[0_2px_0_rgba(0,0,0,1)]">
            <span className="font-pixel text-xl text-white">SCROLL DOWN ▼</span>
          </div>
        </div>
      </header>
      ...
      <section className="relative z-10 py-20 px-4 bg-zinc-900 border-t-4 border-black">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="text-left space-y-6">
            <h2 className="text-4xl font-pixel text-pink-500 mb-6 flex items-center gap-2">
              <Star className="fill-yellow-400 text-black" /> 
              MISSION DETAILS
            </h2>
            ...
            <div className="bg-white text-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,255,1)]">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-bold font-pixel text-xl">THE CEREMONY</h3>
                  <p className="font-console text-lg">{CONFIG.location.timeDisplay}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-console text-lg">
                    {CONFIG.location.placeName}<br/>
                    {CONFIG.location.address}
                  </p>
                  <a href={CONFIG.location.mapLink} target="_blank" rel="noreferrer" className="text-blue-700 underline text-sm hover:text-blue-500">
                    VIEW ON MAP_NET &rarr;
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
             <RetroWindow title="NAVIGATION_SYSTEM // SECTOR_7">
                <div className="relative w-full h-[400px] border-4 border-black bg-black">
                  ...
                  {/* Overlay UI Elements for Y2K vibe */}
                  <div className="absolute top-4 left-4 bg-black/80 border border-green-500 p-2 text-green-500 font-console text-sm pointer-events-none hidden sm:block">
                     COORDINATES: {CONFIG.location.coordinates}<br/>
                     SIGNAL: STRONG
                  </div>
                  <div className="absolute bottom-4 right-4 bg-red-600/20 border border-red-500 p-1 text-red-500 font-pixel animate-pulse pointer-events-none">
                     TARGET ZONE
                  </div>
                </div>
             </RetroWindow>
      ...
      <section className="relative z-10 py-20 bg-[url('https://www.transparenttextures.com/patterns/diagmonds-light.png')] bg-fixed bg-purple-900 text-white border-t-4 border-black">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-center font-pixel text-5xl mb-16 text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-blue-400 drop-shadow-[2px_2px_0_rgba(0,0,0,1)]">
            PLAYERS SELECT
          </h2>
              ...
              <div className="relative border-4 border-black bg-zinc-800 p-2">
                ...
                <div className="bg-black text-white p-4 mt-2">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <a href={CONFIG.couple.groom.instagramUrl} target="_blank" rel="noreferrer" className="bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 p-1 hover:scale-110 transition-transform border border-white">
              ...
              <div className="relative border-4 border-black bg-zinc-800 p-2">
                ...
                <div className="bg-black text-white p-4 mt-2">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <a href={CONFIG.couple.bride.instagramUrl} target="_blank" rel="noreferrer" className="bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 p-1 hover:scale-110 transition-transform border border-white">
                       <div className="bg-black p-1">
                        <Instagram size={20} className="text-white" />
                      </div>
                    </a>
      ...
      {/* --- GIFT SECTION --- */}
      <section className="relative z-10 py-20 px-4 flex flex-col items-center justify-center bg-gray-100 text-black border-t-8 border-pink-500">
         
         <div className="max-w-2xl w-full">
            <div className="bg-white border-4 border-black p-8 shadow-[8px_8px_0_0_rgba(0,0,0,0.2)]">
              <h3 className="text-3xl font-pixel mb-6 text-center">GIFT TRANSFER PROTOCOL</h3>
              <p className="font-console text-lg text-center mb-8">
                Your presence is the greatest present. However, if you wish to contribute to our future honeymoon base construction, here is our data.
              </p>
              
              <div className="bg-gray-200 p-6 border-2 border-dashed border-gray-500 mb-6 flex flex-col items-center gap-4">
                <div className="w-16 h-12 bg-yellow-400 rounded-md shadow border border-black"></div> {/* Simulating Card Icon */}
                <div className="text-center">
                  <p className="font-bold text-xl font-console">{CONFIG.gift.bankName}</p>
                  <p className="font-pixel text-2xl tracking-widest my-2">{CONFIG.gift.accountNumber}</p>
                  <p className="font-console">A/N {CONFIG.gift.accountHolder}</p>
                </div>
                <button 
                  onClick={() => navigator.clipboard.writeText(CONFIG.gift.accountNumber).then(() => alert("COPIED TO CLIPBOARD!"))}
                  className="flex items-center gap-2 bg-black text-white px-4 py-2 font-pixel text-sm hover:bg-gray-800"
                >
                  <Copy size={14} /> COPY NUMBER
                </button>
              </div>
              
              <p className="text-center font-japanese text-gray-500">ありがとうございます</p>
            </div>
         </div>
      ...
      <footer className="relative z-10 bg-black text-white py-12 text-center border-t border-gray-800">
        <GlitchText text="GAME OVER" className="text-4xl font-pixel text-red-600 mb-4 block" />
        <p className="font-console text-gray-500 mb-4">CONTINUE? [Y/N]</p>
        <div className="text-xs text-gray-700 font-mono">
          © 2025 PIXELHEART STUDIOS.<br/>
